#!/bin/bash
# Скрипт для подготовки и публикации на GitHub
...
echo ""
echo "💬 Введите сообщение коммита (или нажмите Enter для 'Update TopNews Bot'):"
read commit_message
commit_message=${commit_message:-"Update TopNews Bot"}
