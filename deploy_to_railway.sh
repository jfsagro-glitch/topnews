#!/bin/bash
# Quick Railway Deployment Guide (Shell version)
# Быстрое руководство развертывания на Railway
...
echo ""
read -p "Вставьте TELEGRAM_TOKEN и нажмите Enter: " TELEGRAM_TOKEN
...
echo ""
read -p "Вставьте TELEGRAM_CHANNEL_ID и нажмите Enter: " TELEGRAM_CHANNEL_ID
...
git add .
read -p "💬 Сообщение коммита (или Enter): " commit_msg
