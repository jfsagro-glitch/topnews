...
### Коммит 7: `10e6866` - Show news preview in popup alert when button is pressed
- **Описание:** Показ предпросмотра при нажатии кнопки
- **Файлы:** bot.py
- **Код:**
```python
...
### Коммит 13: `d35bcc3` - Add news forwarding to admin DMs with button
- **Описание:** Отправка новостей админам с кнопкой
- **Файлы:** bot.py
- **Код:**
```python
